...
<P><ea:DataContext runat="server" ID="dc" OnContextLoad="dc_ContextLoad" TypeName="Soneta.Kadry.Umowa,Soneta.KadryPlace" PageSize=""></ea:DataContext></p>
...
<p>Firma : <ea:DataLabel runat=server DataMember="Wydzial.Nazwa" EncodeHTML="True"></ea:DataLabel></br>
Nazwisko Imię : <ea:DataLabel runat=server DataMember="Pracownik.Nazwisko" EncodeHTML="True"></ea:DataLabel>&nbsp;<ea:DataLabel runat=server DataMember="PracHistoria.Imie" EncodeHTML="True"></ea:DataLabel></br>
Stanowisko : <ea:DataLabel runat=server DataMember="Last.Umowa.Tytul" EncodeHTML="True"></ea:DataLabel></P></br>
