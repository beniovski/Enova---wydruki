...
<TABLE style="WIDTH: 485px; TABLE-LAYOUT: fixed; undefined: " align=center>
  ...
  <TR>
    ...
    <TD><ea:DataLabel runat=server DataMember="PracHistoria.Dokument.Rodzaj" EncodeHTML="True"></ea:DataLabel>: <ea:DataLabel runat="server" DataMember="PracHistoria.Dokument.SeriaNumer" EncodeHTML="True" ID="DokumentNr"></ea:DataLabel> </TD></TR>
  <TR>
    <TD>Uczelnia : </TD>
