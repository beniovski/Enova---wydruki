...
size=4><B>OŚWIADCZENIE O ROZWIĄZANIU UMOWY ZLECENIA NA ZASADZIE POROZUMIENIA 
STRON</B></FONT></FONT></P>
<P class=western style="MARGIN-BOTTOM: 0.28cm; LINE-HEIGHT: 108%" 
...
size=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Strony 
zgodnie oświadczają, iż rozwiązują umowę zlecenie nr <ea:DataLabel runat=server DataMember="Numer.Pelny" EncodeHTML="True"></ea:DataLabel>&nbsp;</FONT></FONT><FONT 
face="Times New Roman, serif"><FONT style="FONT-SIZE: 12pt" size=3>zawartą w 
dniu&nbsp;<ea:DataLabel runat=server DataMember="Last.Umowa.Data" EncodeHTML="True"></ea:DataLabel> &nbsp;pomiędzy 
...
size=3>(zwaną dalej „Zleceniodawcą”) a <ea:DataLabel runat=server DataMember="PracHistoria.Imie" EncodeHTML="True"></ea:DataLabel>&nbsp;<ea:DataLabel runat=server DataMember="PracHistoria.Nazwisko" EncodeHTML="True"></ea:DataLabel>&nbsp;zamieszkały(a) 
<ea:DataLabel runat="server" EncodeHTML="True" ID="adres"> </ea:DataLabel>&nbsp;(zwanym dalej „Zleceniobiorcą”) w 
przedmiocie wykonywania prac. </FONT></FONT><FONT 
face="Times New Roman, serif"><FONT style="FONT-SIZE: 12pt" size=3>Rozwiązanie 
umowy, o której wyżej mowa, następuje z dniem <ea:DataLabel runat="server" EncodeHTML="True" ID="dataZakonczenia"> </ea:DataLabel>&nbsp;na zasadzie 
</FONT></FONT><FONT face="Times New Roman, serif"><FONT style="FONT-SIZE: 12pt" 
...
style="MARGIN-BOTTOM: 0.28cm; LINE-HEIGHT: 108%; TEXT-INDENT: 1.25cm" 
align=justify><FONT face="Times New Roman, serif"><FONT style="FONT-SIZE: 12pt" 
size=3>Niniejsze oświadczenie zostało sporządzone w dwóch jednobrzmiących 
egzemplarzach, po jednym dla każdej ze stron.</FONT></FONT></P>
<P></P>
<P>&nbsp;</P>
<P>&nbsp;</P>
<P>&nbsp;</P>
