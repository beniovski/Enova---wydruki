	...
	<body>
		<form id=form method=post runat="server"><ea:datacontext id="dc" runat="server" oncontextload="dc_OnContextLoad" TypeName="Soneta.KadryPlace"
					LeftMargin="-1" RightMargin="-1">
		                                         ...
		                                         </ea:datacontext><ea:datarepeater id="repeater" runat="server" Height="294px" Width="875px" RowTypeName="Soneta.Place.WyplataEtat,Soneta.KadryPlace"
					...
					<ea:Grid id="gridElements" runat="server" WithSections="False" onbeforerow="gridElements_BeforeRow" DataMember="ElementyWgKolejności">
						<Columns>
                            ...
                            <ea:GridColumn runat="server"  BottomBorder="None" Align="Right" DataMember="Pracownik" Caption="imie i nazwisko " VAlign="Top" CssClass="c0"></ea:GridColumn>
